...
- **px**: Represents an idealized pixel on the viewport. The equivalentasdasd in Android is dp and iOS is pt. Translation tools SHOULD therefore convert to these or other equivalent units as needed.
